        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif     
                    <form method="POST" action="{{ route('guardar_encargado') }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="celular" type="text" class="form-control @error('celuluar') is-invalid @enderror" name="celular" value="{{ old('celular') }}" required autocomplete="celular">
                            </div>
                        </div>
