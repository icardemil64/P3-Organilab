            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <span>
                            <a href="{{route('inicio_prestamos_dispositivos')}}" class="btn btn-primary btn-sm">Restaurar</a>
                    ...
                    <div class="card-body">
                            <form action="{{route('buscar_dispositivo')}}" method="GET" autocomplete="off">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Dispositivo a buscar" aria-label="Buscador" aria-describedby="basic-addon1" name="nombre">
                                </div>
                            </form>
                        <table class="table">
                            <thead>
